...
// Thuan - 20141209
// *****************************************************************************************************************
#define 	false  0		// Src: http://asf.atmel.com/docs/latest/uc3l/html/compiler_8h.html 
#define 	true   1
#define 	CURRENT_CHANNEL_DEFAULT			1

#define 	BPSK_20					(0x00)		// Compliance: IEEE 802.15.4-2003/2006: channel page 0, channel 0 
#define		BPSK_40					(0x04)		// Compliance: IEEE 802.15.4-2003/2006: channel page 0, channel 1 to 10
#define		OQPSK_SIN_RC_100 		(0x08)		// Compliance: IEEE 802.15.4-2006: channel page 2, channel 0
#define		OQPSK_SIN_250 			(0x0C)		// Compliance: IEEE 802.15.4-2006: channel page 2, channel 1 to 10
#define 	OQPSK_SIN_500			(0x0D)		// Compliance: Proprietary 
#define 	OQPSK_SIN_1000_SCR_ON 	(0x2E)		// Compliance: Proprietary 
#define 	OQPSK_SIN_1000_SCR_OFF 	(0x0E)		// Compliance: Proprietary 
#define 	DEFAULT_PHY_MODE		OQPSK_SIN_500
...
#define RST_PULSE_WIDTH_US   ((RST_PULSE_WIDTH_NS + 999) / 1000)				// TRX Parameter: Round up RST_PULSE_WIDTH_NS value to �s 
...
#define P_ON_TO_CLKM_ATTEMPTS       	((unsigned char)(P_ON_TO_CLKM_AVAILABLE_MAX_US/TRX_POLL_WAIT_TIME_US))
// Ratio between max time to transceiver poll delay 
#define SLEEP_TO_TRX_OFF_ATTEMPTS   	((unsigned char)(SLEEP_TO_TRX_OFF_MAX_US/TRX_POLL_WAIT_TIME_US))
...
// *****************************************************************************************************************
// Register addresses of RF module (alphabetical order)
// *****************************************************************************************************************
#define RG_ANT_DIV   		(0x0d)		// Offset for register ANT_DIV 
#define RG_BATMON   		(0x11)		// Offset for register BATMON 
#define RG_CC_CTRL_0   		(0x13)		// Offset for register CC_CTRL_0 
#define RG_CC_CTRL_1   		(0x14)		// Offset for register CC_CTRL_1 
#define RG_CCA_THRES   		(0x09)		// Offset for register CCA_THRES 
#define RG_CSMA_BE   		(0x2f)		// Offset for register CSMA_BE 
#define RG_CSMA_SEED_0   	(0x2d)		// Offset for register CSMA_SEED_0
#define RG_CSMA_SEED_1   	(0x2e)		// Offset for register CSMA_SEED_1
#define RG_FTN_CTRL   		(0x18)		// Offset for register FTN_CTRL 
#define RG_IEEE_ADDR_0  	(0x24)		// Offset for register IEEE_ADDR_0 
#define RG_IEEE_ADDR_1   	(0x25)		// Offset for register IEEE_ADDR_1
#define RG_IEEE_ADDR_2   	(0x26)		// Offset for register IEEE_ADDR_2 
#define RG_IEEE_ADDR_3   	(0x27)		// Offset for register IEEE_ADDR_3 
#define RG_IEEE_ADDR_4   	(0x28)		// Offset for register IEEE_ADDR_4 
#define RG_IEEE_ADDR_5   	(0x29)		// Offset for register IEEE_ADDR_5 
#define RG_IEEE_ADDR_6   	(0x2a)		// Offset for register IEEE_ADDR_6 
#define RG_IEEE_ADDR_7   	(0x2b)		// Offset for register IEEE_ADDR_7 
#define RG_IRQ_MASK   		(0x0e)		// Offset for register IRQ_MASK 
#define RG_IRQ_STATUS   	(0x0f)		// Offset for register IRQ_STATUS 
#define RG_MAN_ID_0   		(0x1e)		// Offset for register MAN_ID_0 
#define RG_MAN_ID_1   		(0x1f)		// Offset for register MAN_ID_1 
#define RG_PAN_ID_0   		(0x22)		// Offset for register PAN_ID_0 
#define RG_PAN_ID_1   		(0x23)		// Offset for register PAN_ID_1 	
#define RG_PART_NUM   		(0x1c)		// Offset for register PART_NUM 
#define RG_PHY_CC_CCA  		(0x08)		// Offset for register PHY_CC_CCA 
#define RG_PHY_ED_LEVEL   	(0x07)		// Offset for register PHY_ED_LEVEL 
#define RG_PHY_RSSI   		(0x06)		// Offset for register PHY_RSSI 
#define RG_PHY_TX_PWR  		(0x05)		// Offset for register PHY_TX_PWR  
#define RG_PLL_CF   		(0x1a)		// Offset for register PLL_CF
#define RG_PLL_DCU   		(0x1b)		// Offset for register PLL_DCU 
#define RG_RF_CTRL_0   		(0x16)		// Offset for register RF_CTRL_0 
#define RG_RF_CTRL_1   		(0x19)		// Offset for register RF_CTRL_1 
#define RG_RX_CTRL   		(0x0a)		// Offset for register RX_CTRL 
#define RG_RX_SYN   		(0x15)		// Offset for register RX_SYN 
#define RG_SFD_VALUE   		(0x0b)		// Offset for register SFD_VALUE 
#define RG_SHORT_ADDR_0   	(0x20)		// Offset for register SHORT_ADDR_0 
#define RG_SHORT_ADDR_1   	(0x21)		// Offset for register SHORT_ADDR_1  
#define RG_TRX_CTRL_0   	(0x03)		// Offset for register TRX_CTRL_0
#define RG_TRX_CTRL_1   	(0x04)		// Offset for register TRX_CTRL_1 	
#define RG_TRX_CTRL_2   	(0x0c)		// Offset for register TRX_CTRL_2 
#define RG_TRX_STATE   		(0x02)		// Offset for register TRX_STATE 
#define RG_TRX_STATUS   	(0x01)		// Offset for register TRX_STATUS 
#define RG_VERSION_NUM  	(0x1d)		// Offset for register VERSION_NUM 
#define RG_VREG_CTRL   		(0x10)		// Offset for register VREG_CTRL 
#define RG_XAH_CTRL_0   	(0x2c)		// Offset for register XAH_CTRL_0 
#define RG_XAH_CTRL_1   	(0x17)		// Offset for register XAH_CTRL_1 
#define RG_XOSC_CTRL   		(0x12)		// Offset for register XOSC_CTRL 
...
// Constant PART_NUM_AT86RF212 for sub-register @ref SR_PART_NUM in register PART_NUM 
#define VER_NUM_AT86RF212   (0x01)

// Constant PART_NUM_AT86RF212 for sub-register @ref SR_PART_NUM in register PART_NUM 
#define MAN_ID0_AT86RF212   (0x1f)

// Constant PART_NUM_AT86RF212 for sub-register @ref SR_PART_NUM in register PART_NUM 
#define MAN_ID1_AT86RF212   (0x00)
...
// Enumerations 
// *****************************************************************************************************************
#define SHORTENUM 		// Null operation: just waste one CPU cycle.


// =================================================================================================================
//////// Receiver ///////
// Static receive buffer that can be used to upload a frame from the TRX
unsigned char at86rfx_rx_buffer[LARGE_BUFFER_SIZE];
// at86rfx_frame_rx = true: received data
unsigned char at86rfx_frame_rx;

//////// Transmitter //////
// Transmit buffer
unsigned char at86rfx_tx_buffer[LARGE_BUFFER_SIZE]; 
unsigned char at86rfx_tx_len; 
...
// =================================================================================================================
// sub-register IRQ_7_BAT_LOW IRQ_6_TRX_UR IRQ_5_AMI IRQ_4_CCA_ED_DONE IRQ_3_TRX_END 
// IRQ_2_RX_START IRQ_1_PLL_UNLOCK IRQ_0_PLL_LOCK in register IRQ_STATUS 
// =================================================================================================================
